...
int solveOpt(vector<int> &A, int B)
{
    ...
    for(int i=0;i<N;i++)
    {
        if(A[i]>B) // Eleemtns greater then B should be swapped
        {
            win+=1;
        }
    }
    ...
    {
        if(A[i]>B) sum+=1; // Eleemtns greater then B should be swapped
    }
...
int main(int argc, const char * argv[]) {
    // insert code here...
    std::cout << "Hello, Swap count to bring number together!\n";
    vector<int> A/*{10, 12, 3, 4, 5, 11, 13, 2, 1}*/
...
;
    cout<<"Swaps required : "<<solveOpt(A, 45)<<endl;
    return 0;
}
