...
- `bm_count_set_bits/` - Count 1s in binary representation
- `bm_single_number/` - Find single number using XOR
- `bm_thrice_numbers/` - Number appearing once (others thrice)
- `bm_add_binary_string/` - Binary string addition
- `bm_subarray_or/` - Subarray OR operations
- `bm_unset_xbitsright/` - Unset rightmost X bits
- `bm_compression_problem/` - Bit compression
- And more...
